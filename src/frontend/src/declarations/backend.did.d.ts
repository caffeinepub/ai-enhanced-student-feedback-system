...
export interface _SERVICE {
  'getAllRegistrants' : ActorMethod<[], Array<Registrant>>,
  'getRegistrant' : ActorMethod<[string], Registrant>,
  'getTotalRegistrants' : ActorMethod<[], bigint>,
  'isRegistered' : ActorMethod<[string], boolean>,
  'registerRegistrant' : ActorMethod<
