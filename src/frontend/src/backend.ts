...
export class Backend implements backendInterface {
    ...
    async getAllRegistrants(): Promise<Array<Registrant>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRegistrants();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getRegistrant(arg0: string): Promise<Registrant> {
        if (this.processError) {
            try {
    ...
    async getTotalRegistrants(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalRegistrants();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerRegistrant(arg0: string, arg1: string, arg2: string, arg3: boolean, arg4: boolean, arg5: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerRegistrant(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
